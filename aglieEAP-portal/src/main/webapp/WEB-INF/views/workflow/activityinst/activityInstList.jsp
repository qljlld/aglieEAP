        ...
        <form id="frmSearch" class="form-horizontal">
            ...
            <fieldset>
            	...
            	<div class="control-group">
            		...
            		<div class="controls">
            			<input type="text" id="subProcessInstID" name="subProcessInstID" value=""/>
                    </div>
            	</div>
            	<div class="control-group">
            		<label for="activityDefID" class="control-label">活动定义ID:</label>
            		<div class="controls">
            			<input type="text" id="activityDefID" name="activityDefID" value=""/>
                    </div>
            	</div>
            	<div class="control-group">
    ...
    $(document).ready(function () {
        var dataSource = new kendo.data.DataSource({
            transport : {
                read : {
                    type : "post",
                    url : "${ctx}/workflow/activityinst/ajaxList",
                    dataType : "json",
        ...
        var activityInstGrid=$("#activityInstGrid");
        var kGrid=activityInstGrid.kendoGrid({
        ...
        activityInstGrid.delegate("tbody>tr", "dblclick", function(){
