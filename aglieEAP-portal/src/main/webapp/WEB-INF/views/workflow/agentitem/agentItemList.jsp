        ...
        <form id="frmSearch" class="form-horizontal">
            ...
            <fieldset>
            	<div class="control-group">
            		...
            		<div class="controls">
            			<input type="text" id="relatedBizID" name="relatedBizID" value=""/>
                    </div>
            	</div>
            	<div class="control-group">
            		<label for="agentID" class="control-label">所属代理:</label>
            		<div class="controls">
            			<input type="text" id="agentID" name="agentID" value=""/>
                    </div>
            	</div>
    ...
    $(document).ready(function () {
        var dataSource = new kendo.data.DataSource({
            transport : {
                read : {
                    type : "post",
                    url : "${ctx}/workflow/agentitem/ajaxList",
                    dataType : "json",
        ...
        var agentItemGrid=$("#agentItemGrid");
        var kGrid=agentItemGrid.kendoGrid({
        ...
        agentItemGrid.delegate("tbody>tr", "dblclick", function(){
