    ...
    $(document).ready(function () {
        var dataSource = new kendo.data.DataSource({
            transport : {
                read : {
                    type : "post",
                    url : "${ctx}/infrastructure/eform/ajaxList",
                    dataType : "json",
        ...
        var eFormGrid=$("#eFormGrid");
        var kGrid=eFormGrid.kendoGrid({
        ...
        eFormGrid.delegate("tbody>tr", "dblclick", function(){
