...
<body>
    ...
    $(document).ready(function () {
    	setDetailWindowHeight(300);
    	setFilterWindowHeight(210);
        var dataSource = new kendo.data.DataSource({
            transport : {
                read : {
                    type : "post",
                    url : "${ctx}/infrastructure/sysparam/ajaxList",
                    dataType : "json",
        ...
        var sysParamGrid=$("#sysParamGrid");
        var kGrid=sysParamGrid.kendoGrid({
        ...
        sysParamGrid.delegate("tbody>tr", "dblclick", function(){
