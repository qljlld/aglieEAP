        ...
        <form id="frmSearch" class="form-horizontal">
            ...
            <fieldset>
            	...
            	<div class="control-group">
            		...
            		<div class="controls">
            			<input type="text" id="uniqueName" name="uniqueName" value=""/>
                    </div>
            	</div>
            	<div class="control-group">
    ...
    $(document).ready(function () {
        var dataSource = new kendo.data.DataSource({
            transport : {
                read : {
                    type : "post",
                    url : "${ctx}/infrastructure/uploadfile/ajaxList",
                    dataType : "json",
        ...
        var uploadFileGrid=$("#uploadFileGrid");
        var kGrid=uploadFileGrid.kendoGrid({
        ...
        uploadFileGrid.delegate("tbody>tr", "dblclick", function(){
