    ...
    $(document).ready(function () {
        ...
        var dataSource = new kendo.data.DataSource({
            transport : {
                read : {
                    type : "post",
                    url : "${ctx}/security/organization/ajaxList",
                    dataType : "json",
        ...
        var organizationGrid=$("#organizationGrid");
        var kGrid=organizationGrid.kendoGrid({
        ...
        organizationGrid.delegate("tbody>tr", "dblclick", function(){
