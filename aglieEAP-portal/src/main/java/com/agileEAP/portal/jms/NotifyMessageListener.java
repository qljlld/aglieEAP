...
import com.agileEAP.utils.email.SimpleMailService;
...
public class NotifyMessageListener implements MessageListener {
	...
	public void onMessage(Message message) {
		try {
			...
			// 打印消息详情
			logger.info("receiveMessage=tranCode:{}, goodsCode:{},destination:{}", mapMessage.getString("tranCode"), mapMessage.getString("goodsCode"),mapMessage.getString("destination"));
